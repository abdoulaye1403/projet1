              ...
              @foreach ($students as $student)
                <tr>
                    ...
                    <td class="text-center">
                        <a href="{{ route('students.show', ['student' => $student]) }}" class="btn btn-primary">Voir</a>
                        <a href="{{ route('students.edit', ['student' => $student]) }}" class="btn btn-warning">Modifier</a>
                        <form id="deleteForm-{{ $student->id }}" action="{{ route('teachers.destroy', ['teacher' => $student]) }}" method="POST" class="d-inline">
                            @csrf
                            @method('DELETE')
